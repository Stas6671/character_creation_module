...
def defence(char_name: str, char_class: str) -> str:
    """Выполните для защиты персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выполните для применения специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выполните для прохождения тренировки персонажа или выхода из игры."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выполните для присвоения класса персонажу."""
    approve_choice: str = ''
    char_class: str = ''
